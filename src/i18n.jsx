...
const DICT = {
  pt: {
    ...
    "pil.3.body": "Faturação sequencial com IVA, taxa turística por hóspede em todos os municípios portugueses que a cobram, gestão RNAL, licenças AL. Pagamentos MB Way, nativos.",
    "pil.3.metric.val": "€ 0",
    ...
    "faq.a6": "O preço público ainda não foi anunciado. Os Founding 20 — os primeiros 20 gestores em beta privada — garantem uma vantagem vitalícia sobre o preço final, canal directo de Slack com a equipa fundadora e primeira palavra no roadmap. Reserve vaga para ser dos primeiros a saber.",
    "faq.q7": "Como é que a Portiqa calcula a taxa turística?",
    "faq.a7": "A Portiqa mantém uma tabela actualizada da taxa turística para todos os municípios portugueses que a cobram e aplica automaticamente a regra correcta por propriedade, por hóspede, por noite — incluindo limites por estadia, isenções por idade e variações sazonais. Os valores cobrados são reconciliados mensalmente com IVA, prontos para a declaração municipal.",
    ...
    "faq.a9": "A Portiqa é fundada por Miguel e Bruno, dois portugueses entre Lisboa e Porto. Os Founding 20 têm canal directo de Slack com ambos os fundadores e influenciam directamente o roadmap do produto.",
  ...
  en: {
    ...
    "pil.3.body": "Sequential IVA invoicing, per-guest tourist tax in every Portuguese municipality that charges it, RNAL tracking, AL license management. MB Way payments, native.",
    "pil.3.metric.val": "€ 0",
    ...
    "faq.a6": "Public pricing hasn't been announced yet. Founding 20 — the first 20 managers in private beta — lock in a lifetime advantage on the final price, a direct Slack channel with the founding team, and first say on the roadmap. Reserve a spot to be among the first to know.",
    "faq.q7": "How does Portiqa calculate tourist tax?",
    "faq.a7": "Portiqa keeps an up-to-date tourist-tax table for every Portuguese municipality that charges it and applies the right rule per property, per guest, per night — including stay caps, age exemptions, and seasonal variations. Amounts collected are reconciled monthly with IVA and ready for municipal filings.",
    ...
    "faq.a9": "Portiqa is founded by Miguel and Bruno, two Portuguese founders between Lisbon and Porto. Founding 20 members get a direct Slack channel with both founders and shape the product roadmap.",
