...
const DICT = {
  pt: {
    ...
    "nav.about": "Sobre",
    "nav.faq": "Perguntas",
    "nav.cta": "Entrar nos Founding 20 →",
    ...
    "hero.lede.b": "O PMS com IA nativa, feito para gestores portugueses de alojamento local com 1 a 100 propriedades. Sincronização de canais, agentes autónomos, conformidade RNAL e taxa turística.",
    ...
    "hero.cta.primary": "Entrar nos Founding 20 →",
    ...
    "sw.foot.caption": "Cenário demonstrativo · Metas medidas no piloto privado com os Founding 20.",
    "sw.foot.1.val": "47s",
    ...
    "pil.3.body": "Faturação sequencial com IVA, taxa turística por hóspede em todos os municípios portugueses que a cobram, gestão RNAL, licenças AL.",
    "pil.3.metric.val": "€ 0",
    ...
    "cmp.lede": "PMS globais (Hostaway, Guesty, Lodgify) são capazes — mas nenhum combina IA autónoma profunda e conformidade portuguesa nativa a preço mid-market. Essa lacuna é a razão de existir da Portiqa.",
    ...
    "cmp.row.5": "Sync Airbnb + Booking + VRBO + Expedia",
    "cmp.row.6": "Anti-overbooking (sync 5 min + failover)",
    "cmp.row.7": "Site de reserva direta com comparador OTA",
    "cmp.row.8": "Promessa",
    ...
    "int.lede": "Canais, pagamentos, documentos e contabilidade — tudo pronto. Nada de extras escondidos.",
    ...
    "sig.whatsapp.placeholder": "+351 9XX XXX XXX",
    ...
    "faq.a1": "A Portiqa é um sistema de gestão de alojamento local (PMS) com IA nativa, construído especificamente para gestores portugueses de arrendamento de curto prazo com 1 a 100 propriedades. Combina sincronização nativa de canais, agentes autónomos de IA (conversas, operações, preços, reviews, conformidade) e a camada portuguesa completa — RNAL, IVA sequencial e taxa turística.",
    ...
    "faq.a4": "A Portiqa está pensada para gestores com 1 a 100 propriedades em Portugal — o perfil que ganha mais ao automatizar operações mas não tem dimensão para um PMS enterprise. Acima de 100 propriedades devemos falar sobre o escalão adequado.",
  ...
  en: {
    ...
    "hero.lede.b": "The AI-native PMS for Portuguese short-term rental managers with 1 to 100 properties. Channel sync, autonomous agents, native RNAL & tourist-tax compliance.",
    ...
    "hero.cta.primary": "Join Founding 20 →",
    ...
    "sw.foot.caption": "Demo scenario · Targets measured in the Founding 20 private pilot.",
    "sw.foot.1.val": "47s",
    ...
    "pil.3.body": "Sequential IVA invoicing, per-guest tourist tax in every Portuguese municipality that charges it, RNAL tracking, AL license management.",
    "pil.3.metric.val": "€ 0",
    ...
    "cmp.lede": "Global PMS tools (Hostaway, Guesty, Lodgify) are capable — but none combine deep autonomous AI and native Portuguese compliance at mid-market pricing. That gap is the whole reason Portiqa exists.",
    "cmp.col.portiqa": "Portiqa",
    ...
    "cmp.row.5": "Airbnb + Booking + VRBO + Expedia sync",
    "cmp.row.6": "Anti-overbooking (5-min sync + failover)",
    "cmp.row.7": "Direct booking site with OTA price compare",
    "cmp.row.8": "Promise",
    ...
    "int.lede": "Channels, payments, documents and accounting — out of the box. No hidden bolt-ons.",
    ...
    "faq.a4": "Portiqa targets managers with 1 to 100 properties in Portugal — the tier that gains the most from automation but isn't big enough for enterprise PMS. Above 100 properties, let's talk about the right pricing tier.",
