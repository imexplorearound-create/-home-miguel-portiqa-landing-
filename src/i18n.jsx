...
const DICT = {
  pt: {
    ...
    "hero.lede.b": "O PMS com IA nativa, feito para gestores portugueses de alojamento local com 5–50 unidades. Sincronização de canais, agentes autónomos, conformidade RNAL e taxa turística. MB Way pronto a usar.",
    "hero.lede.c": "Para o gestor de AL em Portugal, com 5–50 unidades. Seis agentes de IA tratam de mensagens, preços, limpezas, reviews e conformidade. Faça hospitalidade como deve ser — calma, a horas, portuguesa.",
    ...
    // ----- Logos strip -----
    "def.body": "A Portiqa é um PMS português com IA nativa para gestores de 1 a 100 proprietários.",
    ...
    "cmp.row.9": "Escalão de preço (mid-market)",
    "cmp.price.portiqa": "€ 19,90/propriedade/mês · Founding 50: € 13,93",
    "cmp.price.global": "premium",
    "cmp.price.excel": "acessível",
    ...
    "faq.a1": "A Portiqa é um sistema de gestão de alojamento local (PMS) com IA nativa, construído especificamente para gestores portugueses de arrendamento de curto prazo com 5 a 50 unidades. Combina sincronização nativa de canais, agentes autónomos de IA (conversas, operações, preços, reviews, conformidade) e a camada portuguesa completa — RNAL, IVA sequencial, taxa turística e pagamentos MB Way.",
    ...
    "faq.a5": "A Portiqa está pensada para gestores com 5 a 50 unidades em Portugal — o perfil que ganha mais ao automatizar operações mas não tem dimensão para um PMS enterprise. Abaixo de 5 unidades provavelmente não precisa desta camada de automação; acima de 50 devemos falar sobre o escalão adequado.",
    "faq.q6": "Quanto custa a Portiqa?",
    "faq.a6": "O preço público começa em €19,90 por propriedade por mês. Os Founding 50 — os primeiros 50 gestores em beta privada — têm 30% de desconto vitalício, canal directo de Slack com a equipa fundadora e primeira palavra no roadmap.",
  ...
  en: {
    ...
    "hero.lede.b": "The AI-native PMS for Portuguese short-term rental managers with 5–50 units. Channel sync, autonomous agents, native RNAL & tourist-tax compliance. MB Way ready.",
    "hero.lede.c": "Built for the 5–50 unit STR manager in Portugal. Six AI agents handle messages, pricing, cleaning, reviews and compliance. You run hospitality the way it should be — calm, on time, Portuguese.",
    ...
    // Logos
    "def.body": "Portiqa is a Portuguese AI-native PMS for managers of 1 to 100 owners.",
    ...
    "cmp.row.9": "Price tier (mid-market)",
    "cmp.price.portiqa": "€19.90/property/mo · Founding 50: €13.93",
    "cmp.price.global": "premium",
    "cmp.price.excel": "budget",
    ...
    "faq.a5": "Portiqa targets 5–50 unit managers in Portugal — the tier that gains the most from automation but isn't big enough for enterprise PMS. Below 5 units you likely don't need this layer yet; above 50, let's talk about the right pricing tier.",
    "faq.q6": "How much does Portiqa cost?",
    "faq.a6": "Public pricing starts at €19.90 per property per month. Founding 50 — the first 50 managers in private beta — get a lifetime 30% discount, a direct Slack channel with the founding team, and first say on the roadmap.",
    ...
    "faq.a8": "Global PMS tools (Hostaway, Guesty, Lodgify) are capable but weren't built for Portugal. They don't natively handle RNAL, sequential IVA invoicing, or MB Way. Portiqa treats the Portuguese layer as first-class, prices at mid-market (€19.90/property/mo), and runs autonomous AI agents — working while you sleep — rather than merely assistive ones.",
