...
seo_title: "RNAL: como registar um alojamento local em 2026"
meta_description: "Como registar um alojamento local em 2026: passo a passo no Balcão Único, documentos, prazos, custos, zonas de contenção no Porto e em Lisboa, e coimas."
slug: "rnal-registo-alojamento-local"
guia_number: 1
status: "publicado"
...
no_ai_slop: "2026-09-07"
fontes_verificadas: "2026-09-02 — dossier com ~35 fontes; espinha dorsal: Guia Técnico oficial do Turismo de Portugal (jan-2025, pós-DL 76/2024)"
---

# Registo de alojamento local (RNAL) em 2026: o guia completo

Abrir um alojamento local em Portugal continua a ser, no essencial, um processo online e sem taxa nacional, embora vários municípios, como o Porto, cobrem uma taxa municipal na submissão. As regras mudaram várias vezes nos últimos três anos e em 2026 voltaram a mudar. Este guia explica o processo todo, com as regras em vigor a setembro de 2026, verificadas no [guia oficial do Turismo de Portugal](https://business.turismodeportugal.pt/SiteCollectionDocuments/alojamento-local/guia-alojamento-local-jan-2025.pdf) e na legislação publicada.

Escrevo isto como operador: gerimos cerca de 20 apartamentos de alojamento local no Porto. O que está aqui é o que fazemos na prática.
...
**RNAL** é o Registo Nacional de Alojamento Local: a base de dados pública onde cada estabelecimento fica inscrito com um número (por exemplo, `12345/AL`). Sem esse número não podes abrir ao público, e ele é obrigatório em toda a publicidade. O Airbnb e a Booking são obrigados a exibi-lo. Podes consultar qualquer registo em [rnt.turismodeportugal.pt](https://rnt.turismodeportugal.pt).

Desde **1 de novembro de 2024** o registo tem duração indeterminada. A validade de 5 anos e as renovações criadas pelo Mais Habitação foram revogadas. O registo não caduca, mas pode ser cancelado (mais abaixo explico porquê).
...
O mesmo titular (incluindo cônjuge, ascendentes, descendentes e empresas com sócios comuns) só pode explorar mais de 9 apartamentos AL no mesmo edifício se não ultrapassarem **75% das frações**. Acima disso presume-se que é um empreendimento turístico, com outro regime e outra licença.
...
**2. O imóvel tem autorização de utilização adequada?** Precisas da autorização de utilização (ou título válido). Desde o DL 76/2024, explorar AL numa fração habitacional **não constitui uso diverso da habitação**, salvo se o título constitutivo ou o regulamento do condomínio o proibirem, ou se 2/3 do condomínio o deliberarem (só com efeitos para pedidos futuros).
...
- **Placa identificativa "AL"**: obrigatória em todas as modalidades, junto à entrada. O modelo é fixo (Portaria 262/2020): acrílico cristal transparente, 200×200 mm, 10 mm de espessura, "AL" em Arial azul-escuro; há uma versão interior de 100×100 mm. Compra-se a qualquer fornecedor que cumpra o modelo e custa tipicamente à volta de 30 €. Não a afixar é contraordenação.
- **Livros de reclamações, físico e eletrónico**: o físico com letreiro afixado e envio de originais à ASAE em 10 dias úteis; o eletrónico com link para [livroreclamacoes.pt](https://www.livroreclamacoes.pt) visível no teu site e resposta ao consumidor em 15 dias úteis.
- **Seguro de responsabilidade civil**: obrigatório, com **capital mínimo de 75.000 €** por estabelecimento e por sinistro (Portaria 248/2021). Em propriedade horizontal, acresce prova de cobertura de incêndio. A validade do seguro é publicada no RNAL e a falta de seguro é motivo de **cancelamento do registo**. Foi por isso que Lisboa cancelou milhares de registos em 2026.
...
No dia a dia, um AL em Portugal tem estas obrigações permanentes:
...
Na nossa operação, só o SIBA e a taxa turística representam dezenas de registos por mês. É trabalho repetitivo, com prazos curtos e coimas reais, e é um dos problemas que estamos a resolver na Portiqa.

Desde **20 de maio de 2026** o Regulamento (UE) 2024/1028 obriga as plataformas a verificar os números de registo dos anúncios e a partilhar dados com as autoridades. Anúncios sem número de registo válido vão desaparecendo das plataformas.
...
Em fevereiro de 2026, Lisboa cancelou cerca de **6.765 registos** inativos ou sem seguro válido, cerca de 40% do total.

Fora do Porto e de Lisboa, cada município é um caso, e com o DL 151/2026 o mapa pode mudar até ao fim de 2026. Verifica sempre o regulamento municipal antes de avançar.
...
Depende de três coisas que convém verificar antes de gastar um euro: a zona (contenção ou crescimento), o imóvel (autorização de utilização e requisitos) e a tua disponibilidade para a operação, porque o AL tem obrigações semanais.
...
O lado menos bom: nas zonas centrais do Porto e de Lisboa a porta está fechada ou semifechada para novos registos, e a tendência regulatória é de mais escrutínio municipal.

Se avançares, faz as coisas por ordem: zona, imóvel, atividade nas Finanças, comunicação no Balcão Único, requisitos e seguro, e só depois anúncios.
