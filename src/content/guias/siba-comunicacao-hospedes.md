...
seo_title: "SIBA (ex-SEF): como comunicar hóspedes em 2026"
meta_description: "Como comunicar hóspedes estrangeiros no SIBA em 2026: quem é obrigado, prazos de 3 dias úteis, adesão passo a passo, envio pelo PMS e coimas. Guia verificado na lei e no portal oficial."
slug: "siba-comunicacao-hospedes"
guia_number: 2
status: "rascunho"
author: "Miguel Martins"
last_updated: "2026-09-04"
primary_keyword: "siba sef"
secondary_keywords:
  - "siba"
...
fontes_verificadas: "2026-09-04 — dossier com ~25 fontes; espinha dorsal: portal oficial siba.ssi.gov.pt (FAQ + manual v1.5), Lei 23/2007 (arts. 15.º, 16.º e 203.º, versão consolidada) e Guia Técnico do Turismo de Portugal (jan-2025)"
---

# SIBA: comunicar hóspedes estrangeiros em 2026 — o guia completo

Se tens um alojamento local em Portugal, cada hóspede estrangeiro que recebes tem de ser comunicado ao Estado através de um boletim de alojamento — no prazo de 3 dias úteis. É uma das obrigações mais repetitivas do AL: na nossa operação, com cerca de 20 apartamentos no Porto, são dezenas de boletins por mês, todos os meses. Este guia explica quem tem de comunicar, o quê, quando e como, com as regras em vigor a setembro de 2026, verificadas no [portal oficial do SIBA](https://siba.ssi.gov.pt) e na legislação publicada.
...
1. Vai a [siba.ssi.gov.pt](https://siba.ssi.gov.pt) → Área Reservada → **Inscrição**.
...
3. Escolhe a tipologia. Ao selecionares **Alojamento Local** (apartamento, moradia ou estabelecimento de hospedagem), o **número de registo RNAL é obrigatório** — ou seja, primeiro o [registo no RNAL](/guias/rnal-registo-alojamento-local), depois o SIBA.
...
- O **RNAL** legaliza o teu alojamento (registo único, no Balcão Único Eletrónico — [guia completo aqui](/guias/rnal-registo-alojamento-local)).
